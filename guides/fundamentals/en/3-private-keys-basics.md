...
For instance, when creating the wallet on [ROYALEX wallet](https://cryptowallet.am) the user gets a single private key for all cryptocurrencies supported by a wallet.
