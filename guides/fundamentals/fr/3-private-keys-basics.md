...
Par exemple, lors de la création du portefeuille avec [ROYALEX wallet](https://cryptowallet.am) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
