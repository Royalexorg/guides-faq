# What should someone do before using ROYALEX?

Before doing anything on ROYALEX you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over ROYALEX terms (Settings > About section) and make sure they understand what ROYALEX wallet is and risks involved in using the app.
