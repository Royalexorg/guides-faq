# How ROYALEX is different from crypto exchange wallets?
...
When a user uses a non-custodial wallet like ROYALEX the control over funds and access to them doesn't depend on the exchange or any other entity. The user has unconditional and uninterruptible access to funds.
