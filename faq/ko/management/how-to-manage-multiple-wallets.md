...
The Balance tab on ROYALEX always shows the currently active wallet. To switch between activated wallets users may use the wallet switcher button located in the top left section of the Balance tab. Alternatively, this can be done via Settings >> Manage Wallets screen.
