# How ROYALEX recommends transaction fee for Bitcoin?

Well engineered non-custodial wallets incl. ROYALEX are able to estimate the required transaction fee value in order for the Bitcoin transaction to be included within the next block.
