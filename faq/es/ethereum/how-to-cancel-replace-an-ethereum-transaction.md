...
ROYALEX provides a way to cancel or replace transaction while it remains in pending state. Both options can be accessed by clicking on pending transaction in wallet's transactions tab.
